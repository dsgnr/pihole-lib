"""Integration tests for Pi-hole Stats API client."""
...
class TestPiHoleStatsIntegration:
    ...
    def test_get_history(self, pihole_container):
    ...
    def test_get_client_history(self, pihole_container):
    ...
    def test_get_database_history(self, pihole_container):
    ...
    def test_get_database_client_history(self, pihole_container):
    ...
    def test_get_queries(self, pihole_container):
    ...
    def test_get_query_suggestions(self, pihole_container):
    ...
    def test_get_query_types(self, pihole_container):
    ...
    def test_get_recent_blocked(self, pihole_container):
    ...
    def test_get_summary(self, pihole_container):
    ...
    def test_get_top_clients(self, pihole_container):
    ...
    def test_get_top_domains(self, pihole_container):
    ...
    def test_get_upstreams(self, pihole_container):
    ...
    def test_get_database_query_types(self, pihole_container):
    ...
    def test_get_database_summary(self, pihole_container):
    ...
    def test_get_database_top_clients(self, pihole_container):
    ...
    def test_get_database_top_domains(self, pihole_container):
    ...
    def test_get_database_upstreams(self, pihole_container):
    ...
    def test_stats_via_client_property(self, pihole_container):
