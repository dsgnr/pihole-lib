"""Integration tests for PiHoleBackup."""
...
class TestPiHoleBackupExport:
    ...
    def test_export_backup_success(self, pihole_client):
        """Should successfully export backup from Pi-hole."""
        backup_client = PiHoleBackup(pihole_client)
    ...
    def test_export_backup_creates_directory(
        self, pihole_client, pihole_restart_isolation
    ):
    ...
    def test_export_backup_invalid_path(self, pihole_client, pihole_restart_isolation):
...
class TestPiHoleBackupImport:
    ...
    def test_import_backup_with_options(self, pihole_client, pihole_restart_isolation):
        """Should handle import options correctly."""
        from tests.conftest import wait_for_pihole_restart
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            try:
                ...
                wait_for_pihole_restart(pihole_client)
...
class TestPiHoleBackupWorkflows:
    ...
    def test_backup_operations_efficiency(self, pihole_client):
    ...
    def test_constants_usage(self, pihole_client):
        ...
        backup = PiHoleBackup(pihole_client)
