"""Integration tests for PiHoleDomains."""
...
class TestPiHoleDomainsGetDomains:
    ...
    def test_get_domains_all_success(self, pihole_client):
        """Should successfully get all domains from Pi-hole."""
        domains_client = PiHoleDomains(pihole_client)
    ...
    def test_get_domains_with_type_filter(self, pihole_client):
    ...
    def test_get_domains_with_kind_filter(self, pihole_client):
...
class TestPiHoleDomainsAddDomain:
    ...
    def test_add_domain_exact_allow_success(self, pihole_client):
    ...
    def test_add_domain_exact_deny_success(self, pihole_client):
    ...
    def test_add_domain_regex_success(self, pihole_client):
        ...
        # Clean up
        domains_client.delete_domain(regex_pattern, DomainType.DENY, DomainKind.REGEX)

    def test_add_domain_duplicate_error(self, pihole_client):
        ...
        try:
            ...
            # Duplicate handling varies by Pi-hole version
            assert isinstance(result2, DomainMutationResponse)
        except PiHoleAPIError:
            pass  # Expected for duplicate domain
...
class TestPiHoleDomainsGetDomain:
    ...
    def test_get_domain_found(self, pihole_client):
    ...
    def test_get_domain_not_found(self, pihole_client):
...
class TestPiHoleDomainsUpdateDomain:
    ...
    def test_update_domain_success(self, pihole_client):
    ...
    def test_update_domain_move_type(self, pihole_client):
...
class TestPiHoleDomainsDeleteDomain:
    ...
    def test_delete_domain_success(self, pihole_client):
    ...
    def test_delete_nonexistent_domain(self, pihole_client):
...
class TestPiHoleDomainsBatchDelete:
    ...
    def test_batch_delete_domains_success(self, pihole_client):
    ...
    def test_batch_delete_empty_list(self, pihole_client):
...
class TestPiHoleDomainsComplexScenarios:
    ...
    def test_full_domain_lifecycle(self, pihole_client):
        ...
        # 5. Delete domain
        domains_client.delete_domain(domain_name, DomainType.ALLOW, DomainKind.EXACT)
    ...
    def test_mixed_type_and_kind_operations(self, pihole_client):
        ...
        for domain_name, domain_type, domain_kind in test_cases:
            domain = domains_client.get_domain(domain_name, domain_type, domain_kind)
            if domain is not None:
                assert domain.type == domain_type
                assert domain.kind == domain_kind
            # Some regex patterns might not be found due to URL encoding issues
