"""Integration tests for PiHoleConfig."""

import pytest

from pihole_lib import PiHoleConfig
...
class TestPiHoleConfigIntegration:
    ...
    def test_get_config_basic(self, pihole_client):
    ...
    def test_get_config_dns_section(self, pihole_client):
    ...
    def test_get_config_dhcp_section(self, pihole_client):
    ...
    def test_get_config_webserver_section(self, pihole_client):
    ...
    def test_get_config_data_access_patterns(self, pihole_client):
...
class TestPiHoleConfigElementIntegration:
    ...
    def test_get_config_dns_element(self, pihole_client):
    ...
    def test_get_config_dns_upstreams_element(self, pihole_client):
    ...
    def test_get_config_dhcp_element(self, pihole_client):
    ...
    def test_get_config_webserver_element(self, pihole_client):
    ...
    def test_get_config_element_vs_full_consistency(self, pihole_client):
...
class TestPiHoleConfigUpdateIntegration:
    ...
    def test_update_config_dns_upstreams(self, pihole_client):
    ...
    def test_update_config_dns_query_logging(self, pihole_client):
    ...
    def test_update_config_no_restart(self, pihole_client):
    ...
    def test_update_config_multiple_sections(self, pihole_client):
...
class TestPiHoleConfigItemManagementIntegration:
    ...
    def test_add_remove_upstream_dns_server(self, pihole_client):
    ...
    def test_add_remove_dns_host_entry(self, pihole_client):
    ...
    def test_add_remove_config_item_no_restart(self, pihole_client):
    ...
    def test_config_with_property_access(self, pihole_client):
        """Test configuration management using property access on PiHoleClient."""
        # Get configuration using property access
        config_data = pihole_client.config.get_config()
        assert isinstance(config_data, dict)
        assert "dns" in config_data

        # Get DNS configuration
        dns_config = pihole_client.config.get_config("dns")
        assert "dns" in dns_config
        ...
        if original_upstreams != new_upstreams:
            update_config = {"dns": {"upstreams": new_upstreams}}
            updated_config = pihole_client.config.update_config(update_config)
            assert updated_config["dns"]["upstreams"] == new_upstreams

            # Restore original
            restore_config = {"dns": {"upstreams": original_upstreams}}
            pihole_client.config.update_config(restore_config)
